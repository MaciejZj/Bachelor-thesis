...
Do standardowych technik należą: wyrównywanie histogramu oraz odszumianie
i~wyostrzanie zdjęć.
Po analizie zebranych obrazów i~wypróbowaniu wymienionych technik zdecydowano
się jednak nie modyfikować zgromadzonych mateirałów.
Użyty podczczas pomiarów program FLIR Tools posiada wbudowaną funkcję
...
rozdzielczość obrazów zdjęć także nie odszumianio.
Wiele detali ziaren ma wielkość zaledwie paru pikseli, proces odszumiania
mógłby spowodować ich zanik.
Nie oznacza to, jednak że zdjęcia charatkeryzują się przypadkową ekspozycją.
Alogrytmy automatycznego doboru zakresu tepmeratur kamery dbają o to, by
obraz oddawał właściwowści cieplne obiektu.
