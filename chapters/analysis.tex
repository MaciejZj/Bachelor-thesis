...
Drugi argument \mintinline{python}{threshold} decyduje o~poziomie,
powyżej którego punkt jest uznany za maksimum w~sześcianie laplasjanów.
Domyślna wartość tego argumentu \mintinline{python}{threshold} okazała 
...
\ref{eq:newtonlawdiff} \cite{lienhard_heat}, gdzie:
\begin{description}
